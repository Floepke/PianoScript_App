...
def get_appdata_manager() -> AppDataManager:
    ...
    if _appdata_manager is None:
        ...
        # Custom synth wavetable data (left/right single-cycle arrays)
        adm.register("wt_left", [], "Custom wavetable left channel (float list, -1..+1)")
        adm.register("wt_right", [], "Custom wavetable right channel (float list, -1..+1)")
