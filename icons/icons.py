...
Supported extensions: .png, .jpg, .jpeg, .svg, .gif, .bmp, .ezdraw
Note: Qt can directly display PNG/JPG/GIF/BMP. SVG may need QtSvg.
      .ezdraw will be base64-encoded raw; provide PNGs for UI display.
"""
import base64
import pathlib
import sys
...
SUPPORTED = {'.png', '.jpg', '.jpeg', '.svg', '.gif', '.bmp', '.ezdraw'}
